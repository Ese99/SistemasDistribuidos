...
int main(int argc, char* argv[]) {
    // Restauramos el control de argumentos
    if (argc != 4) {
    ...
    // Restauramos la inicialización explícita
    ...
    PI = 4.0 * atan(1.0);
    H = 1.0;
    // Restauramos las posiciones absolutas originales que sabemos que funcionan
    I1 = 6 * 5;  // 30
    I2 = 15 * 5; // 75
    J1 = 4 * 5;  // 20
    M = 1000.0;
    ...
    // SOLUCIÓN POR MÉTODO DE SOBRERELAJACIÓN (Restaurada estructura original)
    ...
    // SALIDA POTENCIAL (POT-MAG) - Mantenemos original
    ...
    // =========================================================================
    // CORRECCIÓN CRÍTICA DE EXPORTACIÓN VECTORIAL (Llenado de gráfica)
    // =========================================================================
    // Volvemos a usar el salto constante 'i += 5' para que las mallas grandes
    // exporten MILES de puntos y "llenen" visualmente el espacio.
    // Para malla 500x500, esto exporta 100x100 = 10,000 vectores ordenados.
